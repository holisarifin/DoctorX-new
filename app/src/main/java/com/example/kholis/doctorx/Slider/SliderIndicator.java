package com.example.kholis.doctorx.Slider;
...
public class SliderIndicator implements ViewPager.OnPageChangeListener {
    ...
    private void initIndicators(){
        ...
        for (int i = 0; i < mPageCount; i++){
            ...
            int dimen = mSize != 0 ? res.getDimensionPixelOffset(mSize) : ((int) res.getDisplayMetrics().density * defaultSizeInDp);
            int margin = mSpacing != 0 ? res.getDimensionPixelSize(mSpacing) : ((int) res.getDisplayMetrics().density * defaultSizeInDp);
